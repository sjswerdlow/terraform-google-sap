...
def GenerateConfig(context):
  ...
  primary_startup_url = "curl " + deployment_script_location + "/sap_hana/startup.sh | bash -s " + deployment_script_location
  secondary_startup_url = "curl " + deployment_script_location + "/sap_hana/startup_secondary.sh | bash -s " + deployment_script_location
