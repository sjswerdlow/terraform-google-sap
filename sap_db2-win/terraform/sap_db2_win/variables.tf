...
variable "db2_backup_size" {
  type = number
  description = "OPTIONAL - Size in GB of X:\\ (Backup) - If set to 0, no disk will be created."
  default = 0
  validation {
...
variable "primary_startup_url" {
  ...
  default = "https://www.googleapis.com/storage/v1/core-connect-dm-templates/202402230649/terraform/sap_db2-win/startup.ps1"
}
