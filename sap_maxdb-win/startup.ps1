...
main-errhandle_log_info "Creating file systems for SAP MaxDB"
main-create_volume 1 D "MaxDB"
main-create_volume 2 L "MaxDB Log"
main-create_volume 3 E "MaxDB Data"
main-create_volume 4 X "Backup"
main-create_volume 5 S "SAP"
main-create_volume 6 P "Pagefile"
nw-create_pagefile
