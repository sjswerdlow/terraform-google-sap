...
def GenerateConfig(context):
  ...
  primary_startup_url = str(context.properties.get('primary_startup_url', "curl -s " + deployment_script_location + "/sap_nfs_ha/startup.sh | bash -s " + deployment_script_location))
  secondary_startup_url = str(context.properties.get('secondary_startup_url', "curl -s " + deployment_script_location + "/sap_nfs_ha/startup_secondary.sh | bash -s " + deployment_script_location))
