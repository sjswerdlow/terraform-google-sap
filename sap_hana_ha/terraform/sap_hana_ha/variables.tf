...
variable "unified_disk_size_override" {
  type = number
  description = "Warning, do not use unless you know what you are doing. Overrides the default size for the primary disk(s), that is based off of the machine_type."
  default = null
}
