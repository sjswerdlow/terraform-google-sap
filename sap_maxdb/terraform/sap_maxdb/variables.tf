...
variable "primary_startup_url" {
  ...
  type        = string
  default     = "curl -s gs://core-connect-dm-templates/202404101403/dm-templates/sap_maxdb/startup.sh | bash -x -s gs://core-connect-dm-templates/202404101403/dm-templates"
}
