...
variable "primary_startup_url" {
  ...
  default     = "curl -s https://www.googleapis.com/storage/v1/core-connect-dm-templates/202404101403/terraform/sap_ase/startup.sh | bash -x -s https://www.googleapis.com/storage/v1/core-connect-dm-templates/202404101403/terraform"
}
