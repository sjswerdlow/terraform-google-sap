...
def GenerateConfig(context):
  ...
  primary_startup_url = "curl " + deployment_script_location + "/sap_emptyha/startup.sh | bash -s " + deployment_script_location
  secondary_startup_url = "curl " + deployment_script_location + "/sap_emptyha/startup_secondary.sh | bash -s " + deployment_script_location
